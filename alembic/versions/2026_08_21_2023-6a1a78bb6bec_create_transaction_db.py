...
down_revision: str | Sequence[str] | None = "e8d440205d4f"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "type", sa.Enum("deposit", "withdraw", native_enum=False), nullable=False
        ),
        sa.Column("amount", sa.Numeric(precision=6, scale=2), nullable=False),
        sa.Column(
            "status",
            sa.Enum("pending", "failed", "success", native_enum=False),
